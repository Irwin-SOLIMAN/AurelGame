      ...
      <div className="Setting">
        <div className="Type">
          ...
          <button
            type="button"
            className={
              type === "number" ? "btnNumber btnStyle2" : "btnNumber btnStyle1"
            }
            value="number"
          ...
          <button
            type="button"
            className={
              type === "letter" ? "btnNumber btnStyle2" : "btnNumber btnStyle1"
            }
            value="letter"
            onClick={(e) => handleChoiceType(e)}
          >
        ...
        <div className="Operator">
          ...
          <button
            type="button"
            className={
              operator === "+" ? "btnNumber btnStyle2" : "btnNumber btnStyle1"
            }
            value="+"
